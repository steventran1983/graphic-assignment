...
class cl_buttons_panel_01:
    def __init__(self, master):
        ...
        self.file_dialog_button = tk.Button(frame, text="Open File", fg="blue", command=self.browse_file)
        self.file_dialog_button.pack(side=tk.LEFT)

        self.draw_object = tk.Button(frame, text="Load", fg="blue", command=self.browse_file)
        self.draw_object.pack(side=tk.LEFT)
...
class cl_toolbar:
    def __init__(self, master):
        ...
        self.button = tk.Button(self.toolbar, text="Load", width=16, command=self.draw_object)
        self.button.pack(side=tk.LEFT, padx=2, pady=2)


        self.button = tk.Button(self.toolbar, text="Toolbar Button 2", width=16, command=self.toolbar_callback) # draw button
